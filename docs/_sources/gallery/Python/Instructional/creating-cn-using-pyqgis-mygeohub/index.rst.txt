    ...
    ---
      **Authors**
      ^^^^^
        ...
        :link-badge:`https://hydroshare.org/user/64/,"Merwade, Venkatesh",cls=badge-primary text-white`
        - Purdue University 
        (`contact <vmerwade@purdue.edu>`_)
        
        :link-badge:`https://hydroshare.org/user/2983/,"Dey, Sayan",cls=badge-primary text-white`
        - Purdue University 
        (`contact <dey6@purdue.edu>`_)
        
        :link-badge:`https://hydroshare.org/user/6348/,"Wang, Shizhang",cls=badge-primary text-white`
        - Purdue 
