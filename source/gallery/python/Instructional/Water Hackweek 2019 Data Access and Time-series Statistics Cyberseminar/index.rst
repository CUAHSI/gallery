...
.. raw:: html
    ...
    <div class=example-title>
        <h1> Waterhackweek2019 Data Access and Time-series Statistics Cyberseminar </h1>
    </div>
    ...
    ---
      **Authors**
      ^^^^^
        ...
        :link-badge:`https://hydroshare.org/user/1509/,"Yifan Cheng",cls=badge-primary text-white`
        -  
        (`contact <yifanc6@uw.edu>`_)
        
        :link-badge:`https://hydroshare.org/user/672/,"Emilio Mayorga",cls=badge-primary text-white`
        - University of Washington 
        (`contact <emiliom@uw.edu>`_)
